...
class Homepage(PageFactory, Common_methods):
    ...
    locators = {"signinBtn": ('XPATH', "//a[@id='signinbuttonhk']"),
                ...
                "Protection": (
                    'XPATH', "//a[@class='dropdown-toggle subnav-trigger'][contains(text(),'Insurance')]"),
                "Investment": (
                    'XPATH', "//a[@class='dropdown-toggle subnav-trigger'][contains(text(),'Investments')]"),
                "About_us": (
                ...
                "submit2": ('XPATH', "//a[contains(text(),'Submit')]"),
